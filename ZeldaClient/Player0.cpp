...
#pragma region Initialize
	...
	{
		stateSystem = {
			{DEFAULT,		std::make_unique<DefaultState>(this)},
			{ATTACH_SELECT, std::make_unique<AttachSelectState>(this)},
			{ATTACH_HOLD,	std::make_unique<AttachHoldState>(this)}
			// {REWIND_SELECT, std::make_unique<RewindState>(this)},
			// {LOCK_SELECT, std::make_unique<LockState>(this)}
		};
